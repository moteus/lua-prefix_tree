...
-- удаление недостижимых префиксов
local function pack_unreach(t)
  --! @todo
end
...
local function self_test()
  ...
  -- Префикс `10` не достежим для более длинных номеров
  -- поэтму он должен быть помечен как флаг false
